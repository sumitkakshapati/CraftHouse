...
urlpatterns = [
    # Products
    path('products/categories/', views.ListCategories.as_view(),
    ...
    path('products/search/<str:keyword>/',
    ...
    path('products/rating/add/', views.CreateProductRating.as_view()),
    ...
    path('products/cart/<int:pk>/', views.ListCartItem.as_view(), name='list_cart'),
