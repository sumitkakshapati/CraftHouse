...
class Image(models.Model):
    ...
    product_id = models.ForeignKey(Product,on_delete = models.CASCADE,default = 0, related_name='images')
...
class ProductReview(models.Model):
    product_id = models.ForeignKey(Product, on_delete = models.CASCADE,default = 0, related_name='reviews')
...
class Questions(models.Model):
    ...
    test_id =  models.ForeignKey(Test,on_delete = models.CASCADE,related_name='question')
    question = models.TextField()
    option1 = models.CharField(max_length = 255)
    option2 = models.CharField(max_length = 255)
    option3 = models.CharField(max_length = 255)
    option4 = models.CharField(max_length = 255)
    correct_answer = models.CharField(max_length = 2,choices=ANSWER_OPTIONS, default = '1')


class Video(models.Model):
    course_id = models.ForeignKey(Course,on_delete = models.CASCADE, default = 0, related_name='videos')
...
class Enrolled(models.Model):
    user_id = models.ForeignKey(User,on_delete = models.CASCADE,default = 0)
    course_id = models.ForeignKey(Course,on_delete = models.CASCADE,default = 0)
    payment_id = models.ForeignKey(CoursePayment, on_delete = models.CASCADE,default = 0)
